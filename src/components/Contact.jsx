...
function Contact() {
  return (
    <section id="contact" className="min-h-screen py-16 text-slate-800 dark:text-white text-center">
      ...
      <div className="flex lg:flex-row flex-col items-center justify-center gap-10 py-16">
        <div className="flex flex-col gap-y-5 mb-8 lg:mb-0">
          ...
          <div className="flex flex-col h-48 text-sm rounded-lg w-60 items-center justify-center p-4 bg-indigo-500/10">
            ...
            <a className="text-indigo-500 hover:text-indigo-700 duration-500" href="https://api.whatsapp.com/send/?phone=%2B918237941681&text&type=phone_number&app_absent=0">
              Send a Message
            </a>
          </div>
        </div>
