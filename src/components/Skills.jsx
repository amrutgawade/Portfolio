...
function Skills() {
  return (
    <section id="skills" className="min-h-screen py-16 dark:text-white text-center">
      ...
      <div className="grid lg:grid-cols-7 grid-cols-3 gap-y-16 mt-16 lg:mx-24">
        <div className="flex items-center justify-center mx-auto p-8 bg-indigo-500/30 h-24 w-24 rounded-sm hover:bg-indigo-500/50 group">
